...
public class NormalTilesView extends PrefixTilesView {
    protected static Logger LOGGER = LoggerFactory.getLogger(NormalTilesView.class);
    ...
    public boolean isValid(HttpServletRequest servletRequest) {
        boolean isNormal = SitePreferenceUtils.getCurrentSitePreference(servletRequest).isNormal();
